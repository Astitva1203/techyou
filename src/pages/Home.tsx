      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-white/80">We believe in Technology</span>
          </motion.div>
          ...
          >
            ...
            Tech <span className="text-gradient">You</span>
          </motion.h1>
          ...
          >
            ...
            <a
              href="https://arithmo-teal.vercel.app/"
              target="_blank"
