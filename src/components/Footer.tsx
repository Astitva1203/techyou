        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-white/60 max-w-sm mb-6">
              We believe in Technology. Helping students and businesses build powerful tech solutions for a better tomorrow.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="https://arithmo-teal.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-primary transition-colors">Arithmo</a></li>
            </ul>
          </div>
