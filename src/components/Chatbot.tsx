          ...
          >
            ...
            <div className="p-4 border-b border-white/10 flex items-center justify-between bg-black/40">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-black/30 border border-white/10 flex items-center justify-center overflow-hidden">
                  <img src="/techyou.png" alt="Tech You" className="w-full h-full object-cover" />
                </div>
                <div>
                  <h3 className="font-display font-semibold text-sm">Tech You Help</h3>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
              ...
              {isLoading && (
                <div className="flex gap-3 max-w-[85%]">
                  <div className="w-8 h-8 rounded-full bg-black/30 border border-white/10 flex items-center justify-center shrink-0 overflow-hidden">
                    <img src="/techyou.png" alt="Tech You" className="w-full h-full object-cover" />
                  </div>
